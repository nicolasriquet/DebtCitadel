...
function top_ten_debt_contexts(critical, high, medium, low, ticks) {
    data1 = [
        {
            data: critical,
            color: "#d9534f",
...
/*
        debt_context_metrics.html
*/

function open_debt_items_burndown(critical, high, medium, low, info, y_max, y_min) {
    var options = {
        xaxes: [{
            mode: "time",
            timeformat: "%Y/%m/%d"
    ...
    var plotObj = $.plot($("#open_debt_items_burndown"), [{
                data: critical,
                label: " Critical",
                color: "#d9534f",
            }, {
...
/*
        view_debt_context_details.html
*/
...
/*
        debt_item_pdf_report.html
*/

/*
        debt_context_endpoint_pdf_report.html
*/

function accepted_debt_items(d1, d2, d3, d4, d5, ticks) {
    var data = [
        {
            label: "Critical",
            data: d1,
...
/*
        debt_context_pdf_report.html
*/

/*
        debt_context_type_pdf_report.html
*/

function debt_item_age(data_1, ticks) {
    var dataset = [
    ...
    var options = {
        ...
        yaxis: {
            axisLabel: "Number of Debt Items",
            axisLabelUseCanvas: true,
            axisLabelFontSizePixels: 12,
            axisLabelFontFamily: 'Verdana, Arial',
            axisLabelPadding: 3,
    ...
    $.plot("#debt_item_age", dataset, options);
}

function open_debt_items(d1, d2, d3, d4, d5, ticks) {
    var data = [
        {
            label: "Critical",
            data: d1,
...
function closed_debt_items(d1, d2, d3, d4, d5, ticks) {
    var data = [
        {
            label: "Critical",
            data: d1,
