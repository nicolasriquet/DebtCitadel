...
class DojoAppConfig(AppConfig):
    ...
    def ready(self):
        ...
        watson.register(self.get_model('Debt_Context'), fields=get_model_fields_with_extra(self.get_model('Debt_Context'), ('id', 'debt_context_type__name', )), store=('debt_context_type__name', ))

        watson.register(self.get_model('Debt_Test'), fields=get_model_fields_with_extra(self.get_model('Debt_Test'), ('id', 'debt_engagement__debt_context__name', )), store=('debt_engagement__debt_context__name', ))  # debt_test_type__name?

        watson.register(self.get_model('Debt_Item'), fields=get_model_fields_with_extra(self.get_model('Debt_Item'), ('id', 'url', 'unique_id_from_tool', 'debt_test__debt_engagement__debt_context__name', 'debt_jira_issue__jira_key', )),
                        store=('status', 'debt_jira_issue__jira_key', 'debt_test__debt_engagement__debt_context__name', 'severity', 'severity_display', 'latest_note'))
        ...
        watson.register(self.get_model('Debt_Item_Template'))
        watson.register(self.get_model('Debt_Endpoint'), store=('debt_context__name', ))  # add debt_context name also?
        watson.register(self.get_model('Debt_Engagement'), fields=get_model_fields_with_extra(self.get_model('Debt_Engagement'), ('id', 'debt_context__name', )), store=('debt_context__name', ))
        watson.register(self.get_model('App_Analysis'))
        watson.register(self.get_model('Vulnerability_Id'), store=('debt_item__debt_test__debt_engagement__debt_context__name', ))
