...
urlpatterns = [
    ...
    re_path(r'^debt_context/(?P<pid>\d+)/report$',
            views.debt_context_report, name='debt_context_report'),
    re_path(r'^product/(?P<pid>\d+)/endpoint/report$',
        views.product_endpoint_report, name='product_endpoint_report'),
    re_path(r'^debt_context/(?P<pid>\d+)/endpoint/report$',
            views.debt_context_endpoint_report, name='debt_context_endpoint_report'),
    re_path(r'^engagement/(?P<eid>\d+)/report$', views.engagement_report,
        name='engagement_report'),
    re_path(r'^debt_engagement/(?P<eid>\d+)/report$', views.debt_engagement_report,
