...
env = environ.Env(
    ...
    DD_DATABASE_NAME=(str, 'debtdojo'),
    # default django database name for testing is test_<dbname>
    #DD_TEST_DATABASE_NAME=(str, 'test_defectdojo'),
    DD_TEST_DATABASE_NAME=(str, 'test_debtdojo'),
    #DD_DATABASE_PASSWORD=(str, 'defectdojo'),
    DD_DATABASE_PASSWORD=(str, 'debtdojo'),
    #DD_DATABASE_PORT=(int, 3306),
    DD_DATABASE_PORT=(int, 5432),
    #DD_DATABASE_USER=(str, 'defectdojo'),
    DD_DATABASE_USER=(str, 'debtdojo'),
    #DD_SECRET_KEY=(str, ''),
    DD_SECRET_KEY=(str, 'GaAiQPWLdltxOICr87ntGaAiQPWLdltxOICr87ntGaAiQPWLdltxOICr87ntGaAiQPWLdltxOICr87ntGaAiQPWLdltxOICr87nt'),
    #DD_CREDENTIAL_AES_256_KEY=(str, '.'),
    DD_CREDENTIAL_AES_256_KEY=(str, 'GaAiQPWLdltxOICr87ntGaAiQPWLdltxOICr87ntGaAiQPWLdltxOICr87ntGaAiQPWLdltxOICr87ntGaAiQPWLdltxOICr87ntGaAiQPWLdltxOICr87ntGaAiQPWLdltxOICr87ntGaAiQPWLdltxOICr87ntGaAiQPWLdltxOICr87nt'),
